...
namespace mygl3
{
	...
	public:
		...
		{
			glProgramUniform4iv(program_, loc, 1, glm::value_ptr(vector4));
		}
		void SetIVec3(GLint loc, const glm::ivec3 &vector3)
		{
			glProgramUniform3iv(program_, loc, 1, glm::value_ptr(vector3));
		}
		void SetIVec2(GLint loc, const glm::ivec2 &vector2)
		{
			glProgramUniform2iv(program_, loc, 1, glm::value_ptr(vector2));
		}
		...
		{
			glProgramUniform2fv(program_, loc, 1, glm::value_ptr(vector2));
		}
